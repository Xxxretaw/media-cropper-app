...
- Corresponding source: [ffmpeg-8.1.2.tar.xz](https://ffmpeg.org/releases/ffmpeg-8.1.2.tar.xz)
...
The distributed Apple Silicon binaries are built from the unmodified FFmpeg 8.1.2 release source with FFmpeg libraries linked statically into the two command-line programs. Their remaining dynamic dependencies are macOS system libraries and frameworks. The build does not enable GPL, nonfree, or third-party Homebrew codec libraries.
...
This software is based in part on the work of the Independent JPEG Group. No changes were made to the Independent JPEG Group-derived files in the FFmpeg 8.1.2 source release.
